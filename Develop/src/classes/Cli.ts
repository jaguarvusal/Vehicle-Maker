...
class Cli {
  // update the vehicles property to accept a mixed array of Car, Truck, and Motorbike objects
  vehicles: (Car | Truck | Motorbike)[];
  selectedVehicleVin: string | undefined;
  exit: boolean = false;

  // update the constructor to accept a mixed array of Car, Truck, and Motorbike objects
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (selectedVehicleVin === truck.vin) {
          ...
          const vehicleToTow = this.vehicles.find(vehicle => vehicle.vin === selectedVehicleVin);
          if (vehicleToTow) {
